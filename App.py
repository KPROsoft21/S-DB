...
class Student:
    def __init__(self,root):
        ...
        title=Label(self.root,text="SOT's Student Management System",bd=10,relief=GROOVE, font=('cambria',40,"bold"),bg="royal blue",fg="white")
        ...
        m_title=Label(Manage_Frame,text="Manage Students",bg="royal blue",fg="white",font=('times new roman',30,"bold"))
